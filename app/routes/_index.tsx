...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <header className="bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 text-white py-16 sm:py-24 px-4 relative">
        {/* Simplified background for initial render */}
        ...
        {isLoaded && (
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div
              className="absolute w-64 h-64 rounded-full mix-blend-multiply will-change-transform top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
              style={{
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <div className="inline-flex px-4 py-1.5 bg-white/10 text-sm font-medium rounded-full mb-6 items-center gap-2">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight tracking-tight">
              <span className="text-white">{Index.title}</span>
            </h1>

            <p className="text-lg sm:text-xl text-blue-50/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              {Index.subtitle}
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/#featured-languages" className="w-full sm:w-auto">
                <button className="w-full bg-white px-6 py-3 rounded-xl text-blue-600 font-bold flex items-center justify-center gap-3 min-w-[180px] active:scale-[0.98] transform-gpu">
                  <span>{Index.startJourney}</span>
                  <IoNavigateOutline className="w-5 h-5 text-blue-600" />
                </button>
              </Link>

              <Link to="#learn-more" className="w-full sm:w-auto">
                <button className="w-full border-2 border-white/20 px-6 py-3 rounded-xl text-white font-bold flex items-center justify-center gap-3 min-w-[180px] hover:bg-white/5 active:scale-[0.98] transform-gpu">
        ...
        <div className="absolute inset-x-0 bottom-0">
          <div className="h-8 sm:h-12 bg-white/[0.02]" />
        </div>
      </header>
