...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans flex flex-col px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24 3xl:px-32 py-8 sm:py-16 lg:py-24 relative overflow-hidden">
      <div className="max-w-8xl mx-auto w-full flex flex-col">
        <main className="flex-1">
          <div className="w-full space-y-8 bg-indigo-900 bg-opacity-50 p-4 sm:p-6 lg:p-8 rounded-lg shadow-2xl">
